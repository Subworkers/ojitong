...
from data.const import POST_TYPE, DATA_TYPE

RESOURCES_PATH = Path(DATA_BASE_PATH***REMOVED*** / "bench"

def save_bench_data_jsonl_by_types(post_type: POST_TYPE, data_type: DATA_TYPE, samples: list***REMOVED***:
...
def set_filename_by_data_type(data_type: DATA_TYPE***REMOVED***:
...
def generate_s3_path(bucket_name="ojitong", prefix="news_data", extension=".csv", today_datetime: datetime=datetime.today(***REMOVED******REMOVED***:
